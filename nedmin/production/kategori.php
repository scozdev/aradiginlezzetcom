              ...
              <tbody>
                ...
                while($kategoricek=$kategorisor->fetch(PDO::FETCH_ASSOC)) { $say++?>
                  ...
                  <tr>
                   ...
                   <td><img width="200" src="../../<?php echo $kategoricek['kategori_resim'] ?>"></td>
                   ...
                   <td>
                    ...
                    <center>
                      ...
                      if ($kategoricek['kategori_durum']==0) { ?>
                        ...
                        <a href="../netting/islem.php?kategori_id=<?php echo $kategoricek['kategori_id'] ?>&kategori_one=1&kategori_durum=ok"><button class="btn btn-warning btn-xs">Aktif Et</button></a>

                      <?php } elseif ($kategoricek['kategori_durum']==1) {?>

                       <a href="../netting/islem.php?kategori_id=<?php echo $kategoricek['kategori_id'] ?>&kategori_one=0&kategori_durum=ok"><button class="btn btn-danger btn-xs">Pasif Et</button></a>
