...
<div class="right_col" role="main">
  <div class="">
   ...
   <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">kategori_title <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" name="kategori_title"class="form-control col-md-7 col-xs-12"  value="<?php echo $kategoricek['kategori_title'] ?>" >
                </div>
              </div>

              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">kategori_description <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <textarea class="form-control" name="kategori_description" required="required" id="tarif_lezzet" rows="3"  value="" ><?php echo $kategoricek['kategori_description'] ?></textarea>
                  
                </div>
              </div>

              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">kategori_keywords <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" name="kategori_keywords" required="required" class="form-control col-md-7 col-xs-12"  value="<?php echo $kategoricek['kategori_keywords'] ?>" >
                </div>
              </div>
